...
<?php
	if(!isset($_SESSION['id_user'])){
		...
		echo "Te has apuntado a  este concierto.
		Mucha suerte!";
		$query="insert into  Subasta (codigo_usuario, codigo_concierto, estado_subasta) values ($codigo_usuario, $codigo_concierto, 1);";
		$result=mysqli_query($con, $query);
		header("refresh:3; url='PaginacionConciertos.php");
	mysqli_close($con);
				}
			}
?>
