...
<?php
	...
	if(!isset($_SESSION['id_user'])){
				...
				if($tipo_usuario!=1){
					...
					$codigo=$_GET['codigo'];
					$codigo_usu = $_SESSION['id_user'];
					$query="select * from Subasta s, Usuario u 
					where s.codigo_usuario=u.codigo_usuario and codigo_concierto=$codigo;";
					...
					echo "<table border=1>
					<tr><td>Nombre musico</td><td>Estado candidatura</td><td>Contratar</td></tr>";
				...
				echo "<td>Rechazado</td>";
					...
					echo "<td><a href='CambiarCandidatura.php?codigo_concierto=$codigo&codigo_musico=$codigo_usuario'>Contratar musico</a></td></tr>";
				}
